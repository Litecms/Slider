...
namespace Litecms\Slider\Http\Requests;
...
class SliderRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('slider');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access slider module,
    ...
    {
        return user()->canDo('slider.slider.view');
    }
}

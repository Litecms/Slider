                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[name]" class="col-sm-2 control-label">
                                        {!! trans('slider::slider.label.name')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[title1]" class="col-sm-2 control-label">
                                        {!! trans('slider::slider.label.title1')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[title1]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[status]" class="col-sm-2 control-label">
                                        {!! trans('slider::slider.label.status')!!}
                                    </label>
                                    <div class="col-sm-10">
...
$(document).ready(function(){
    ...
    $(".slider-slider .btn-open").click(function(){
        ...
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/slider.slider.search')!!}");
